...
async function restoreSession(data) {
    ...
    if (data.background) {
        ...
        const fakeResult = {
            ...
            notes: bg.notes || [],
            // Abstract Background distillation generated by the LLM
            // alongside the body Background.  Persisted with the section
            // so it survives reloads and flows into the export payload.
            abstract_background: bg.abstract_background || '',
        };
