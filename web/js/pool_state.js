...
const POOL_PHASES = {
    ...
    EMPTY: {
        ...
        'btn-reprocess-pool':   { visible: false },
    ...
    INTEGRATED: {
        ...
        'btn-reprocess-pool':   { visible: true,  enabled: true },
        'btn-reset-pool':       { visible: true,  enabled: true },
        'btn-clear-files':      { visible: false },
    ...
    // Pool is fully approved.  Reprocess rebuilds caches without touching
    // files or approvals.  Reset Pool is the destructive nuclear option.
    APPROVED: {
        'btn-validate':         { visible: true,  enabled: false, text: 'Validate' },
        'btn-integrate':        { visible: true,  enabled: false, text: 'Integrate' },
        'btn-approve-pool':     { visible: true,  enabled: false, text: 'Approve' },
