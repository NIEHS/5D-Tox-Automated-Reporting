"""
Dose-response analysis layer for the bmdx interpretation engine.

Holds the BMD-ranking tables (gene sets and individual genes), the mygene.info
description lookups, the BMD-ordering / organ-signature computations, and the
context-assembly functions that turn a ToxKBQuerier + dose-response dataframe
into the plain-text context the narrative layer consumes.  Extracted from
interpret.py: this layer references no LLM-endpoint or narrative names, which is
why it forms a clean cut.
"""
